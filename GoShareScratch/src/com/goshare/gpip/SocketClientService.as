package com.goshare.gpip
{
    ...
    [Event(name="connect", type="com.goshare.gpip.LocalSocketConnectEvent")]

	[Event(name="disconnect", type="com.goshare.gpip.LocalSocketConnectEvent")]

	[Event(name="error", type="com.goshare.gpip.LocalSocketConnectEvent")]

	[Event(name="receiveMessage", type="com.goshare.gpip.LocalSocketConnectEvent")]

	[Event(name="connectLibLog", type="com.goshare.gpip.ConnectLibLogEvent")]

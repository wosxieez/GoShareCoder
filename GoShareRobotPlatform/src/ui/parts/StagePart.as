    ...
    public class StagePart extends UIPart {
        ...
        private function showPlayButton():void {
            ...
            if (!playButton) {
                ...
                playButton.graphics.drawRect(0, 0, Scratch.fullStageWidth, Scratch.fullStageHeight);
                var flag:Bitmap = Resources.createBmp('playerStartFlag');
                flag.x = (Scratch.fullStageWidth - flag.width) / 2;
                flag.y = (Scratch.fullStageHeight - flag.height) / 2;
                playButton.alpha = .9;

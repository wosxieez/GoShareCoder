...
public class ImageCanvas extends Sprite {
	...
	static public const canvasWidth:uint = Scratch.fullStageWidth;
	static public const canvasHeight:uint = Scratch.fullStageHeight;
	static private const canvasBorderWidth:uint = 25;
	static private const scrollbarThickness:int = 9;
	static private const maxZoom:Number = 2;
	...
	private function createLayers():void {
		...
		if (editor is BitmapEdit) {
			...
			var bm:BitmapData = new BitmapData(1280, 720, true, 0);
			visibleArea.addChild(bitmapLayer = new Bitmap(bm));
			bitmapLayer.scaleX = bitmapLayer.scaleY = 1;
			visibleArea.addChild(segmentationLayer = new Bitmap(bm.clone()));
			segmentationLayer.scaleX = segmentationLayer.scaleY = 1;

...
package {
    ...
    public class Specs {
        ...
        public static var commands:Array = [
            ...
            // goshare blocks
            ["打开sb2独立播放器（测试，暂时打开无法关闭）",	"", 13, "openSb2Player"],
			["工程载入完毕", "h", 13, "loadProjectComplete"],
            ["连接Gpip平台", " ", 13, "connectGpip"],
			["连接C1控制器", " ", 13, "connectControler"],
			["-"],
			["发现人脸来到", "h", 13, "peopleFaceNear"],
			["发现人脸离开", "h", 13, "peopleFaceLeave"],
			["当前来人身份", "r", 13, "getPeopleIdentity"],
			["当前来人名字", "r", 13, "getPeopleName"],
			["-"],
			["听到来人说话", "h", 13, "hearPeopleSaid"],
			["来人说话内容", "r", 13, "peopleSaidTxt"],
			["-"],
			["获得机器人说的话", "h", 13, "hearRobotSaid"],
			["机器人说话内容", "r", 13, "robotSaidTxt"],
			["-"],
            ["机器人说 %s", " ", 13, "robotSaid", '你好'],
			["%m.openAndClose 人脸识别功能", " ", 13, "faceFuncOpenAndClose", "打开"],
			["%m.openAndClose 语音识别功能", " ", 13, "asrFuncOpenAndClose", "打开"],
			["%m.openAndClose 摄像头", " ", 13, "cameraOpenAndClose", "打开"],
			["%m.openAndClose 屏幕", " ", 13, "screenOpenAndClose", "打开"],
			["音量增大 %n", " ", 13, "volumeIncrease", 1],
			["音量减小 %n", " ", 13, "volumeDecrease", 1],
			["-"],
			["机器人问 %s 并等待答复", " ", 13, "robotAskAndWait", '你叫什么名字呀？'],
			["答复", "r", 13, "peopleAnswer"],
			["-"],
			["%s 包含 %s",	"b", 13, "include"],
			["当 %n 点 %n 分时",	"h", 13, "whenTimeUp", 0, 0]
			/*["机器人发出 %m.openAndClose 的表情", " ", 13, "screenOpenAndClose", "打开"],*/
        ];
    }}

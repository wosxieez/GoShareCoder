...
//----------
	...
	/**
	 * 初始化工程，触发 "工程加载完毕"的Block事件
	 */
	public function autoRunMainApp():void {
		function startPlayMainApp(stack:Block, target:ScratchObj):void {
			if (stack.op == 'loadProjectComplete') interp.toggleThread(stack, target);
		}
		stopAll();
		lastAnswer = '';
		lastPeopleAnswer = '';
		...
		setTimeout(function():void {
			allStacksAndOwnersDo(startPlayMainApp);
		}, 0);
	}
	...
	// Robot Ask prompter
	//------------------------------
	private var waitPeopleAnswer:Boolean;

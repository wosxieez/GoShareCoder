...
public class BlockArg extends Sprite {
	...
	public function setArgValue(value:*, label:String = null):void {
		...
		// this is used for sprite names and to support com.goshare.translation
		argValue = value;
		if (field != null) {
	...
	private function blockArgFilters():Array {
		// com.goshare.filters for BlockArg outlines
	...
	private function textChanged(evt:*):void {
		...
		if (evt && Sb2Player.app) Sb2Player.app.setSaveNeeded();
	}

...
//
// WaveformView implements a simple com.goshare.sound editor that can record, play, and edit sounds.
...
package com.goshare.soundedit {
	...
	import com.goshare.ui.parts.SoundsPart;
...
public class WaveformView extends Sprite implements DragClient {
	...
	private function initEditorData():void {
		// Set the initial editor data for this com.goshare.sound.
	...
	private function playBuffer(evt:SampleDataEvent):void {
		// Fill the next com.goshare.sound buffer with samples. Write several copies of each each original
		...
		if (playbackStarting) {
			if (i < count) {
				// Very short com.goshare.sound or selection; pad with enough zeros so com.goshare.sound actually plays.
				for (i = 0; i < 2048; i++)
	...
	public function mouseDown(evt:MouseEvent):void { Sb2Player(root).gh.setDragClient(this, evt) }

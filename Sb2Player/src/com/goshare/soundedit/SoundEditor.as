...
public class SoundEditor extends Sprite {
	...
	public function SoundEditor(app:Sb2Player, soundsPart:SoundsPart) {
		this.app = app;
	...
	public function keyDown(evt:KeyboardEvent):void {
		if (!stage || stage.focus) return; // com.goshare.sound editor is hidden or someone else has keyboard focus; do nothing

...
public class Translator {
	...
	public static function initializeLanguageList():void {
		...
		Sb2Player.app.server.getLanguageList(saveLanguageList);
	}
	...
	public static function setLanguageValue(lang:String):void {
		...
		setFontsFor('en');
		if ('en' == lang) Sb2Player.app.translationChanged(); // there is no .po file English
		else Sb2Player.app.server.getPOFile(lang, gotPOFile);

	}
	
	public static function setLanguage(lang:String):void {
		if ('import com.goshare.translation file' == lang) { importTranslationFromFile(); return; }
		if ('set font size' == lang) { fontSizeMenu(); return; }

		setLanguageValue(lang);
		Sb2Player.app.server.setSelectedLang(lang);
	}
	...
	private static function fontSizeMenu():void {
		...
		m.showOnStage(Sb2Player.app.stage);
	}
	...
	private static function checkBlockTranslations():void {
		...
		for each (var spec:String in Sb2Player.app.extensionManager.getExtensionSpecs(false)) checkBlockSpec(spec);
	}

...
//
// This class is used to collect strings for com.goshare.translation.
// Call collectAndExport() to write a file of com.goshare.translation strings.
//
...
package com.goshare.translation {
	...
	import com.goshare.svgeditor.*;
	import com.goshare.ui.*;
...
public class TranslatableStrings {
	...
	static public function exportCommands():void {
		...
		addAll(Sb2Player.app.extensionManager.getExtensionSpecs(true));
	...
	public static function exportUIStrings():void {
		...
		// Get the strings from the com.goshare.Sb2Player app instance so that the offline version can add strings
		addAll(Sb2Player.app.strings());

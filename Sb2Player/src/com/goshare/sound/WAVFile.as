...
public class WAVFile {
	...
	public static function empty():ByteArray {
		// Return com.goshare.sound containing a single zero-valued sample.
		// Note: A totally empty WAV file is considered broken by QuickTime and perhaps other com.goshare.sound tools.
	...
	public static function extractSamples(waveData:ByteArray):Vector.<int> {
		...
		try {
			...
			Sb2Player.app.log(LogLevel.WARNING, 'Error extracting samples from WAV file', {error: e});

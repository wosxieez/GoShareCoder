...
//
// A ScratchSoundPlayer outputs com.goshare.sound samples to Flash. This class
...
public class ScratchSoundPlayer {
	...
	// com.goshare.sound being played
	...
	// com.goshare.sound data, step size, and current stream position
	...
	protected var bytePosition:int;  // use our own position to allow com.goshare.sound data to be shared
	...
	public function startPlaying(doneFunction:Function = null):void {
		...
		if (soundChannel) {
			...
			// User has no com.goshare.sound card or too many sounds already playing.
			stopPlaying();

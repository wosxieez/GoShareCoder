...
// It works be converting the MP3 data into a Flash com.goshare.sound instance, then
...
// Note: To avoid having to support MP3 format com.goshare.sound in future versions of com.goshare.Sb2Player,
// the ability to embed MP3 com.goshare.sound in projects is being deprecated. When an MP3 com.goshare.sound
// is imported, it is converted to a compressed, mono WAV com.goshare.sound. This MP3SoundPlayer
// is still used for previewing sounds before importing.

package com.goshare.sound.mp3 {
	import flash.events.*;
	import flash.media.*;
	import flash.utils.*;
	import com.goshare.scratch.ScratchSound;
	import com.goshare.sound.ScratchSoundPlayer;
	import com.goshare.sound.mp3.*;
...
public class MP3SoundPlayer extends ScratchSoundPlayer {
	...
	private function writeSampleData(evt:SampleDataEvent):void {
		...
		if (n < 4096) {
			soundChannel = null; // don't explicitly stop the com.goshare.sound channel in this callback; allow it to stop on its own
			stopPlaying();
		}
	}

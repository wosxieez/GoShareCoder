...
package com.goshare.sound {
	import flash.utils.*;
	import com.goshare.soundbank.Instr;
...
public class SoundBank {
	...
	public static function getNotePlayer(instNum:int, midiKey:int):NotePlayer {
		// Return a NotePlayer for the given com.goshare.Sb2Player 2.0 instrument number (1..21)
	...
	public static function getDrumPlayer(drumNum:int, isMIDI:Boolean, secs:Number):NotePlayer {
		...
		// use a com.goshare.Sb2Player 1.4 MIDI drum number (35..81).
		Instr.initSamples();
	...
	// -----------------------------
	// com.goshare.Sb2Player 2.0 Instrument Definitions
	//------------------------------
	...
	//
	// The loop points are -1 if the com.goshare.sound is unlooped (e.g. Marimba).
	...
	// -----------------------------
	// com.goshare.Sb2Player 2.0 Drum Definitions
	//------------------------------
	...
	// Approximate com.goshare.Sb2Player 1.4 (i.e. MIDI) drums using com.goshare.Sb2Player 2.0 drum samples.

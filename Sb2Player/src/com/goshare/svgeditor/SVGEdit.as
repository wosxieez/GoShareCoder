...
import com.goshare.svgeditor.ColorPicker;
import com.goshare.svgeditor.objs.*;
	...
	public class SVGEdit extends ImageEdit {
		...
		public function SVGEdit(app:Sb2Player, imagesPart:ImagesPart) {
		...
		override protected function selectHandler(event:Event = null):void {
			...
			// Reset the smoothness com.goshare.ui
		...
		private function insertOldTextLayer():void {
			...
			// It's fairly close for Helvetica Bold, the default font in com.goshare.Sb2Player 1.4.

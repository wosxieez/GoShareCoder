...
package com.goshare.svgeditor.tools
{
	...
	import com.goshare.svgeditor.tools.PathEndPointManager;
...
//pathReversed.outputCommands();
					...
					fill1.getElement().setAttribute('com.goshare.scratch-type', 'backdrop-fill');
					...
					fill2.getElement().setAttribute('com.goshare.scratch-type', 'backdrop-fill');
					...
					bisector.getElement().setAttribute('com.goshare.scratch-type', 'backdrop-stroke');

...
import com.goshare.svgeditor.objs.*;
import com.goshare.svgeditor.objs.ISVGEditable;
import com.goshare.svgeditor.tools.*;
...
import com.goshare.ui.parts.ImagesPart;
...
public class ImageEdit extends Sprite {
	...
	public function ImageEdit(app:Sb2Player, imagesPart:ImagesPart) {
		this.app = app;

...
public class SVGExport {
	...
	public function svgString():String {
		...
		rootNode = new XML("<svg xmlns='http://www.w3.org/2000/svg' version='1.1' " +
				...
				"<!-- Exported by com.goshare.Sb2Player - http://com.goshare.scratch.mit.edu/ -->\n"+
			"</svg>");
	...
	private function addImageNodeTo(el:SVGElement, xml:XML):void {
		...
		const attrList:Array = ['x', 'y', 'width', 'height', 'opacity', 'com.goshare.scratch-type'];
	...
	private function addPathNodeTo(el:SVGElement, xml:XML):void {
		...
		const attrList:Array = ['fill', 'stroke', 'stroke-width', 'stroke-linecap', 'stroke-linejoin', 'opacity', 'com.goshare.scratch-type'];
		var node:XML = createNode(el, attrList);
		node.setName('path');

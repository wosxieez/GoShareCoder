...
//
// SVGDisplayRender is optimized for for displaying an SVG image as a com.goshare.Sb2Player costume
...
public class SVGDisplayRender {
	...
	public function renderAsSprite(rootSVG:SVGElement, doShift:Boolean = false, forHitTest:Boolean = false):Sprite {
		// Return a sprite containing all the SVG elements that com.goshare.Sb2Player can render.

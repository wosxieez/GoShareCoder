...
public class SVGElement {
	...
	public function isBackDropBG():Boolean {
		return ('com.goshare.scratch-type' in attributes && attributes['com.goshare.scratch-type'].indexOf('backdrop-') === 0);
	}

	public function isBackDropFill():Boolean {
		return ('com.goshare.scratch-type' in attributes && attributes['com.goshare.scratch-type'] == 'backdrop-fill');
	}

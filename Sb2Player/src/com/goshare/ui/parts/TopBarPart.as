...
//
// This part holds the com.goshare.Sb2Player Logo, cursor tools, screen mode buttons, and more.
...
public class TopBarPart extends UIPart {
	...
	public function TopBarPart(app:Sb2Player) {
		this.app = app;
		addButtons();
		refresh();
	}
	...
	public static function strings():Array {
		if (Sb2Player.app) {
			Sb2Player.app.showFileMenu(Menu.dummyButton());
			Sb2Player.app.showEditMenu(Menu.dummyButton());
		}

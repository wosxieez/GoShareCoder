...
// as well as the com.goshare.sound recorder, editor, and import button.

package com.goshare.ui.parts {
	...
	import com.goshare.soundedit.SoundEditor;
	import com.goshare.translation.Translator;
	import com.goshare.ui.media.*;
...
public class SoundsPart extends UIPart {
	...
	public function SoundsPart(app:Sb2Player) {
		this.app = app;
	...
	public static function strings():Array {
		new SoundsPart(Sb2Player.app).showNewSoundMenu(Menu.dummyButton());
		return [
			'New com.goshare.sound:', 'recording1',
			'Choose com.goshare.sound from library', 'Record new com.goshare.sound', 'Upload com.goshare.sound from file',
		];
	}

	public function updateTranslation():void {
		newSoundLabel.text = Translator.map('New com.goshare.sound:');
		editor.updateTranslation();
		SimpleTooltips.add(libraryButton, {text: 'Choose com.goshare.sound from library', direction: 'bottom'});
		SimpleTooltips.add(recordButton, {text: 'Record new com.goshare.sound', direction: 'bottom'});
		SimpleTooltips.add(importButton, {text: 'Upload com.goshare.sound from file', direction: 'bottom'});
		fixlayout();
	}
	...
	private function addListFrame():void {
		...
		listFrame.contents.backgroundColor = CSS.tabColor;
	...
	public function soundFromLibrary(b:* = null):void {
		app.getMediaLibrary("com.goshare.sound", app.addSound).open();
	}

	public function soundFromComputer(b:* = null):void {
		app.getMediaLibrary("com.goshare.sound", app.addSound).importFromDisk();
	}

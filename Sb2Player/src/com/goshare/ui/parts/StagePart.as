...
//
// This part frames the com.goshare.Sb2Player stage and supplies the UI elements around it.
// Note: The com.goshare.Sb2Player stage is a child of StagePart but is stored in an app instance variable (app.stagePane)
...
public class StagePart extends UIPart {
	...
	private const readoutTextColor:int = Sb2Player.app.isExtensionDevMode ? CSS.white : CSS.textColor;
	...
	public function StagePart(app:Sb2Player) {
		this.app = app;
		outline = new Shape();
		addChild(outline);
		addTitleAndInfo();
	...
	private function drawOutline():void {
		...
		g.clear();
        /// 哥学项目修改  舞台区域头部透明
		//drawTopBar(g, topBarColors, getTopBarPath(w - 1, topBarHeight), w, topBarHeight, com.goshare.CSS.borderColor);
	...
	private function addTitleAndInfo():void {
        ...
        versionInfo = makeLabel(Sb2Player.versionString, versionFormat)
	}

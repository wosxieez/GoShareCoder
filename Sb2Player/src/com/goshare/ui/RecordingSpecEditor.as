...
public class RecordingSpecEditor extends Sprite {
	...
	public function RecordingSpecEditor() {
		...
		addChild(notSavedLabel = makeLabel('that the video will not be saved on com.goshare.Sb2Player.',14));
	...
	public function soundFlag():Boolean {
		// True if the 'include com.goshare.sound from project' box is checked.
	...
	public function microphoneFlag():Boolean {
		// True if the 'include com.goshare.sound from microphone' box is checked.
	...
	private function addCheckboxesAndLabels():void {
		checkboxLabels = [
		makeLabel('Include com.goshare.sound from project', 14),
		makeLabel('Include com.goshare.sound from microphone', 14),

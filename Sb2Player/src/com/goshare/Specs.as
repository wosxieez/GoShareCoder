...
//		b. add a primitive for the new command to the com.goshare.interpreter
...
package com.goshare {
    ...
    public class Specs {
        ...
        public static var variableColor:int = 0xEE7D16; // com.goshare.Sb2Player 1.4: 0xF3761D
        public static var listColor:int = 0xCC5B22; // com.goshare.Sb2Player 1.4: 0xD94D11
        ...
        public static const categories:Array = [
            ...
            [2,  "Looks",		0x8a55d7],
            [3,  "Sound",		0xbb42c3],
            [4,  "Pen",			0x0e9a6c], // com.goshare.Sb2Player 1.4: 0x009870
            [5,  "Events",		0xc88330],
            [6,  "Control",		0xe1a91a],
            [7,  "Sensing",		0x2ca5e2],
        ...
        public static var commands:Array = [
            ...
            // com.goshare.sound
            ["play com.goshare.sound %m.com.goshare.sound",					" ", 3, "playSound:",						"pop"],
            ["play com.goshare.sound %m.com.goshare.sound until done",		" ", 3, "doPlaySoundAndWait",				"pop"],
            ...
            // obsolete com.goshare.blocks from com.goshare.Sb2Player 1.4 that may be used in older projects
            ["play drum %n for %n beats",			" ", 98, "drum:duration:elapsed:from:", 1, 0.25], // com.goshare.Sb2Player 1.4 MIDI drum
            ["set instrument to %n",				" ", 98, "midiInstrument:", 1],
            ["loud?",								"b", 98, "isLoud"],

            // obsolete com.goshare.blocks from com.goshare.Sb2Player 1.4 that are converted to new forms (so should never appear):
            ["abs %n",								"r", 98, "abs"],
            ["sqrt %n",								"r", 98, "sqrt"],
            ...
            ["播放PPT %s", " ", 13, "goSharePDF:", 'hello.pdf'],
            ["播放 %s 字第 %n 画", " ", 13, "goShareSWF:", '静', 1],
            [" %s 点开始上课 %s ", " ", 13, "classPlan:", ' 上午9点 ', ' 语文 '],
            ["教学切片 %s", "c", 13, "doIfGoShare"]
        ];
    }}

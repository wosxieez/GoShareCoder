...
//
// This class embeds the com.goshare.sound data for com.goshare.Sb2Player instruments and drums.
// The static variable 'samples' is a dictionary of named com.goshare.sound buffers.
// Call initSamples() to initialize 'samples' before using.
//
// All instrument and drum samples were created for com.goshare.Sb2Player by:
//
//		Paul Madden, paulmatthewmadden@yahoo.com
//
// Paul is an excellent com.goshare.sound designer and we appreciate all the effort
// he put into this project.

package com.goshare.soundbank {
	import flash.utils.*;
...
public class Instr {
	...
	public static function initSamples():void {
		// Initialize the dictionary of named com.goshare.sound buffers.
		// Details: Build the dictionary by enumerating all the embedded sounds in this file
		// (i.e. constants with a value of type 'class'), extracting the com.goshare.sound data from the
	...
	private static function getWAVSamples(wavData:ByteArray):ByteArray {
		// Extract a com.goshare.sound buffer from a WAV file. Assume the WAV file contains 16-bit, uncompressed com.goshare.sound data.

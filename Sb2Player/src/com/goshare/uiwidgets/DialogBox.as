...
public class DialogBox extends Sprite {
	...
	public static function ask(question:String, defaultAnswer:String, stage:Stage = null, resultFunction:Function = null, context:Dictionary = null):void {
		...
		d.showOnStage(stage ? stage : Sb2Player.app.stage);
	}
	...
	private function drawBackground():void {
		var titleBarColors:Array = [0xE0E0E0, 0xD0D0D0]; // old: com.goshare.CSS.titleBarColors;
		var borderColor:int = 0xB0B0B0; // old: com.goshare.CSS.borderColor;

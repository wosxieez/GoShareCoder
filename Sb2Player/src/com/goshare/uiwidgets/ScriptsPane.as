...
public class ScriptsPane extends ScrollFrameContents {
	...
	public function ScriptsPane(app:Sb2Player) {
		this.app = app;
...
return true; // xxx disable this check for now; it was causing confusion at com.goshare.Sb2Player@MIT conference
	...
	private function dropCompatible(droppedBlock:Block, target:DisplayObject):Boolean {
		const menusThatAcceptReporters:Array = [
			'broadcast', 'costume', 'backdrop', 'scene', 'com.goshare.sound',

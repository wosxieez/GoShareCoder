...
public class GestureHandler {
	...
	public function GestureHandler(app:Sb2Player, inIE:Boolean) {
		this.app = app;
...
//		if (app.scriptsPane) app.scriptsPane.draggingDone();
	...
	private function handleDrag(evt:MouseEvent):void {
		...
		if (!app.editMode) {
			...
			if ((mouseTarget is Watcher) || (mouseTarget is ListWatcher)) return; // don't drag com.goshare.watchers in presentation mode
		}

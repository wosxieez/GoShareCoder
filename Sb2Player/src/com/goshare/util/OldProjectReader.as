...
public class OldProjectReader {
	...
	private function fixWatchers(newStage:ScratchStage):void {
		...
		// Update the contents of visible list com.goshare.watchers.
	...
	private function fixCommentRefs(comments:Array, stacks:Array):void {
		...
		var blockListOld:Array = [null]; // com.goshare.Sb2Player 1.4 blockRefs are 1-based
		var blockListNew:Array = []; // com.goshare.Sb2Player 2.0 blockRefs are 0-based

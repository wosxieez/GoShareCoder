...
package com.goshare {
    ...
    import com.goshare.extensions.ExtensionDevManager;
    import com.goshare.extensions.ExtensionManager;
    import com.goshare.interpreter.Interpreter;
    import com.goshare.logging.Log;
    import com.goshare.logging.LogEntry;
    import com.goshare.logging.LogLevel;
    import com.goshare.render3d.DisplayObjectContainerIn3D;
    import com.goshare.scratch.BlockMenus;
    import com.goshare.scratch.PaletteBuilder;
    import com.goshare.scratch.ReadyLabel;
    import com.goshare.scratch.ScratchCostume;
    import com.goshare.scratch.ScratchObj;
    import com.goshare.scratch.ScratchRuntime;
    import com.goshare.scratch.ScratchSound;
    import com.goshare.scratch.ScratchSprite;
    import com.goshare.scratch.ScratchStage;
    import com.goshare.svgeditor.tools.SVGTool;
    import com.goshare.translation.Translator;
    import com.goshare.ui.CameraDialog;
    import com.goshare.ui.LoadProgress;
    import com.goshare.ui.media.MediaInfo;
    import com.goshare.ui.media.MediaLibrary;
    import com.goshare.ui.media.MediaPane;
    import com.goshare.ui.parts.LibraryPart;
    import com.goshare.ui.parts.StagePart;
    import com.goshare.uiwidgets.BlockColorEditor;
    import com.goshare.uiwidgets.CursorTool;
    import com.goshare.uiwidgets.DialogBox;
    import com.goshare.uiwidgets.IconButton;
    import com.goshare.uiwidgets.Menu;
    import com.goshare.util.Base64Encoder;
    import com.goshare.util.CachedTimer;
    import com.goshare.util.GestureHandler;
    import com.goshare.util.ProjectIO;
    import com.goshare.util.ScreenUtil;
    import com.goshare.util.Server;
    import com.goshare.util.Transition;
    import com.goshare.watchers.ListWatcher;
    ...
    public class Sb2Player extends Sprite {
        // Version
        public static const versionString:String = 'V1.0.0';
        public static var app:Sb2Player; // static reference to the app, used for debugging
...
//        public var soundsPart:SoundsPart;
        ...
        public function Sb2Player() {
            addEventListener(Event.ADDED_TO_STAGE, thisAddedToStageHandler);
        }
        ...
        protected function initialize():void {
            ...
            gh = new GestureHandler(this, false);
            initInterpreter();
            initRuntime();
...
//            playerBG = new Shape(); // create, but don't add
        ...
        private function loadGithubURL(urlOrArray:*):void {
            ...
            if (urlArray) {
                ...
                // Filter URLs: allow at most one project file, and wait until it loads before loading com.goshare.extensions.
...
//            imagesPart = new ImagesPart(this);
        ...
        public function getMediaPane(app:Sb2Player, type:String):MediaPane {
...
//            imagesPart.editor.enableTools(flag);
        ...
        public function updatePalette(clearCaches:Boolean = true):void {
            ...
            // definitions, so this is a convenient place to clear the com.goshare.interpreter's caches.
...
//            topBarPart.x = 0;
//            topBarPart.y = 0;
//            topBarPart.setWidthHeight(w, 50);
            ...
            if (stagePart) {
                ...
                stagePart.x = stagePart.y = 0
                stagePart.scaleX = w / playerW
                stagePart.scaleY = h / playerH
            }
        }
...
//            g.drawRect(0, 0, stage.stageWidth, stage.stageHeight);
        ...
        public function translationChanged():void {
            // The com.goshare.translation has changed. Fix scripts and update the UI.
        ...
        protected function addFileMenuItems(b:*, m:Menu):void {
            ...
            if (b.lastEvent.shiftKey && jsEnabled) {
                ...
                m.addItem('Import experimental extension', function ():void {
                    ...
                    d.addTitle('Load Javascript com.goshare.Sb2Player Extension');
                    d.addField('URL', 120);
...
//            m.showOnStage(stage, b.x, topBarPart.bottom() - 1);
        ...
        private function showAboutDialog():void {
            DialogBox.notify(
                    'com.goshare.Sb2Player 2.0 ' + versionString,
...
//                scriptsPane.saveScripts(false);
        ...
        // TODO: calculate field width for up to 40 hex digits of com.goshare.CSS.normalTextFont
        ...
        protected function makeVersionDetailsDialog():DialogBox {
            ...
            d.addField('com.goshare.scratch-flash', kGitHashFieldWidth, SCRATCH::revision);
            return d;
        }
        ...
        public function setLanguagePressed(b:IconButton):void {
            ...
            if (b.lastEvent.shiftKey) {
                m.addItem('import com.goshare.translation file');
...
//            m.showOnStage(stage, b.x, topBarPart.bottom() - 1);
        ...
        protected function revertToOriginalProject():void {
            function preDoRevert():void {
                revertUndo = new ProjectIO(Sb2Player.app).encodeProjectAsZipFile(stagePane);
                doRevert();
            }
...
//                soundsPart.selectSound(snd);
        ...
        private function thisAddedToStageHandler(event:Event):void {

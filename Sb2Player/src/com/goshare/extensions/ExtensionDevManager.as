...
import com.goshare.uiwidgets.Button;
...
public class ExtensionDevManager extends ExtensionManager {
	...
	public function ExtensionDevManager(app:Sb2Player) {
		super(app);
	}
	...
	public function makeLoadExperimentalExtensionButton():Button {
		...
		button.setEventAction(function (evt:MouseEvent):void {
			if (evt.shiftKey) {
				...
				Sb2Player.app.setModalOverlay(true);
				Sb2Player.app.externalCall('JSshowExtensionDialog');
			}
		});
	...
	public function loadAndWatchExtensionFile(ext:ScratchExtension = null):void {
		...
		var filter:FileFilter = new FileFilter('com.goshare.Sb2Player 2.0 Javascript Extension', '*.js');
		var self:ExtensionDevManager = this;
		Sb2Player.loadSingleFile(function (e:Event):void {

...
// This file also defines the com.goshare.extensions built into com.goshare.Sb2Player (e.g. WeDo, PicoBoard).
//
...
public class ScratchExtension {
	...
	public var host:String = '127.0.0.1'; // most com.goshare.extensions run on the local host
	public var port:int = 0;
	public var id:uint = 0;
	public var blockSpecs:Array = [];
	public var isInternal:Boolean;
	public var useScratchPrimitives:Boolean; // true for com.goshare.extensions built into com.goshare.Sb2Player (WeDo, PicoBoard) that have custom com.goshare.primitives
	...
	public static function PicoBoard():ScratchExtension {
		// Return a descriptor for the com.goshare.Sb2Player PicoBoard extension.
		var result:ScratchExtension = new ScratchExtension(ExtensionManager.picoBoardExt, 0);
		result.isInternal = true;
		result.javascriptURL = Sb2Player.app.server.getOfficialExtensionURL('picoExtension.js');
		result.thumbnailMD5 = '82318df0f682b1de33f64da8726660dc.png';
		result.url = 'http://wiki.com.goshare.scratch.mit.edu/wiki/PicoBoard_Blocks';
	...
	public static function WeDo():ScratchExtension {
		...
		result.isInternal = true;
		result.javascriptURL = Sb2Player.app.server.getOfficialExtensionURL('wedoExtension.js');
		result.thumbnailMD5 = '9e5933c3b8b76596d1f889d44d3715a1.png';
		result.url = 'http://wiki.com.goshare.scratch.mit.edu/wiki/LEGO_WeDo_Blocks';
		result.tags = ['hardware'];
	...
	public static function WeDo2():ScratchExtension {
		...
		result.isInternal = true;
		result.javascriptURL = Sb2Player.app.server.getOfficialExtensionURL('wedo2Extension.js');

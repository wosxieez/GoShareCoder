...
import com.goshare.ui.ProcedureSpecEditor;
import com.goshare.ui.media.MediaLibrary;
import com.goshare.ui.parts.UIPart;
...
public class PaletteBuilder {
	...
	public function PaletteBuilder(app:Sb2Player) {
		this.app = app;
	}
...
//		app.palette.updateSize();
	...
	protected function addExtensionButtons():void {
		...
		if (Sb2Player.app.isExtensionDevMode) {
			var extensionDevManager:ExtensionDevManager = Sb2Player.app.extensionManager as ExtensionDevManager;
...
//		}
	...
	protected function getExtensionMenu(ext:ScratchExtension):Menu {
		function showAbout():void {
			if (ext.isInternal) {
				// Internal com.goshare.extensions are handled specially by tip-bar.js

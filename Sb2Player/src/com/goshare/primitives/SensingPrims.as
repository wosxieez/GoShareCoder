...
//
// Sensing com.goshare.primitives.
...
public class SensingPrims {
	...
	public function SensingPrims(app:Sb2Player, interpreter:Interpreter) {
		this.app = app;
	...
	public function addPrimsTo(primTable:Dictionary):void {
		...
		// variable and list com.goshare.watchers
...
//			testSpr.addChild(stageBMTest);
//			myBMTest = new Bitmap();
//			myBMTest.com.goshare.filters = [new GlowFilter(0xFF00FF)];
//			testSpr.addChild(myBMTest);
//		}
//		myBMTest.bitmapData = myBM;
//		stageBMTest.bitmapData = stageBM;

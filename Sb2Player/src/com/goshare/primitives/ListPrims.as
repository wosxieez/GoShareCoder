...
public class ListPrims {
	...
	public function ListPrims(app:Sb2Player, interpreter:Interpreter) {
		this.app = app;
	...
	private function primContains(b:Block):Boolean {
		...
		for each (var el:* in list.contents) {
			// use com.goshare.Sb2Player comparison operator (com.goshare.Sb2Player considers the string '123' equal to the number 123)

...
//
// Miscellaneous com.goshare.primitives. Registers other primitive modules.
// Note: A few control structure com.goshare.primitives are implemented directly in Interpreter.as.
...
public class Primitives {
	...
	public function Primitives(app:Sb2Player, interpreter:Interpreter) {
		this.app = app;
	...
	protected function addOtherPrims(primTable:Dictionary):void {
        ...
        new GoSharePrims(app, interp).addPrimsTo(primTable)
	}

...
public class SoundPrims {
	...
	public function SoundPrims(app:Sb2Player, interpreter:Interpreter) {
		this.app = app;
	...
	public function addPrimsTo(primTable:Dictionary):void {
		...
		primTable["drum:duration:elapsed:from:"]	= primPlayDrum; // com.goshare.Sb2Player 1.4 drum numbers
		...
		primTable["midiInstrument:"]				= primSetInstrument; // com.goshare.Sb2Player 1.4 instrument numbers
	...
	private function primSetInstrument(b:Block):void {
		// Set com.goshare.Sb2Player 2.0 instrument.
	...
	// Map from a com.goshare.Sb2Player 1.4 (i.e. MIDI) instrument number to the closest com.goshare.Sb2Player 2.0 equivalent.

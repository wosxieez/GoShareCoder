...
//
// Looks com.goshare.primitives.

package com.goshare.primitives {
...
public class LooksPrims {
	...
	public function LooksPrims(app:Sb2Player, interpreter:Interpreter) {
		this.app = app;
	...
	public function addPrimsTo(primTable:Dictionary):void {
		...
		primTable['showBackground:']		= primShowCostume; // used by com.goshare.Sb2Player 1.4 and earlier (doesn't start scene hats)
		primTable['nextBackground']			= primNextCostume; // used by com.goshare.Sb2Player 1.4 and earlier (doesn't start scene hats)
...
//		primTable['yScroll']				= function(b:*):* { return app.stagePane.yScroll };
	...
	private function primChangeEffect(b:Block):void {
		...
		s.applyFilters();
		if (s.visible || s == Sb2Player.app.stagePane) interp.redraw();
	}
	...
	private function primSize(b:Block):Number {
		...
		return Math.round(s.getSize()); // reporter returns rounded size, as in com.goshare.Sb2Player 1.4
	}

...
//
// com.goshare.Sb2Player motion and pen com.goshare.primitives.
...
public class MotionAndPenPrims {
	...
	public function MotionAndPenPrims(app:Sb2Player, interpreter:Interpreter) {
		this.app = app;
	...
	private function primStamp(b:Block):void {
		...
		var alpha:Number = (Sb2Player.app.isIn3D ?
